...
export function LoginScreen({ onLogin }: LoginScreenProps) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden bg-black">
      {/* Gradiente turquesa diagonal */}
      <div className="absolute inset-0 bg-gradient-to-br from-transparent via-[#00e0b8]/30 to-transparent"></div>
      ...
      <div className="relative z-10 w-full max-w-md space-y-8 animate-in fade-in-0 slide-in-from-bottom-4 duration-1000">
        <div className="text-center space-y-4">
          ...
          <div className="space-y-2">
            ...
            <p className="text-white">Acesse sua conta com sua chave API</p>
          </div>
        </div>
        ...
        <Card className="bg-card/95 backdrop-blur-sm border-border/60 shadow-2xl">
          <CardHeader className="space-y-1">
            ...
            <CardDescription className="text-center text-white">Insira sua chave API para acessar o dashboard</CardDescription>
          </CardHeader>
          <CardContent>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    className="pr-10 bg-background/50 border-border/60 focus:border-primary focus:ring-primary/20 placeholder:text-white"
                    disabled={isLoading}
                  />
                  <Button
                    type="button"
                ...
                <DialogContent className="sm:max-w-[600px] bg-card/95 backdrop-blur-sm border-border/60">
                  ...
                  <div className="aspect-video">
                    <iframe
                      width="100%"
                      height="100%"
                      src="https://www.youtube.com/embed/yAKKy_s4EGI"
